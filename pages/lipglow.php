...
<head>
    ...
    <title>Lip Glow - Cressida Beauty</title>
...
<body>
    <div class="content-1">
        ...
        <!-- img header start -->
        <div class="mt-5 p-0 img-header"></div>
        <!-- img header end -->

        <!-- content sectiton 1 start -->
        <section class="jumbotron container-1" style="padding-bottom: 0px !important;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 my-1">
                        <div class="col-md-6 p-0 mx-auto">
                            <h1 class="lipglow-bigtext text-capitalize" style="margin-top: 90px;">cressida<br>lip glow</h1>
                            <h4 class="mt-4 lipglow-subtitle">Your Time to Glow</h4>
                        </div>
                        <div class="col-md-6 mx-auto p-0">
                            <p class="mt-4 lipglow-text">Let’s be a part of #GlowSquad! We stay in
                                constant communication that each of our
                                products are made to reach every single one
                                of you inclusively, because we believe that
                                beauty is for everybody and we believe in
                                your own version of beautiful.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 my-1" style="z-index: 2;">
                        <img class="img-fluid" width="420" src="../assets/img/lipglow-foto1.png" alt="">
                    </div>
                </div>

                <!-- img lipstick blur -->
                <div class="col-md-10 mx-auto d-flex justify-content-center" style="margin-top: -70px; z-index: 1;">
                    <img src="../assets/img/lipblur.png" class="img-fluid" width="800" alt="">
                </div>

                <!-- all shade -->
                <h2 class="mt-4 text-center allshade-title">All Shade in All Your Glow</h2>
                <div class="col-md-5 pr-0 mx-auto allshade-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                    euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad
                </div>
                <div class="mt-5 col-md-10 p-0 d-flex justify-content-center mx-auto">
                    <img class="img-fluid" width="870" src="../assets/img/lipglow-foto2.png" alt="">
                </div>
            </div>
        </section>
        <!-- section 1 end -->
        ...
        <!-- section 2 start -->
        <section class="jumbotron container-2" style="background-color: #F1E5CB !important;">
            <div class="col-md-9 mt-5 mx-auto">
                <div class="row mx-auto justify-content-center">
                    <div class="card lipglow-card-2 border-0 rounded-0 px-0 my-2">
                        <div class="img-product-lipglow">
                            <img src="../assets/img/lipglow-boudicca.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            <p class="card-title product-text-title-1">BOUDICCA LIP GLOW</p>
                        </div>
                        <a href="moreinfo-lipglow.php" class="btn btn-product-1 rounded-0 btn-block">MORE INFOGLOW</a>
                    </div>
                    <img class="py-2 mr-4" src="../assets/img/lipglow-orang-boudicca.png" alt="">

                    <div class="card lipglow-card-2 border-0 rounded-0 px-0 my-2">
                        <div class="img-product-lipglow">
                            <img src="../assets/img/lipglow-harriet.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            <p class="card-title product-text-title-1">HARRIET LIP GLOW</p>
                        </div>
                        <a href="moreinfo-lipglow.php" class="btn btn-product-1 rounded-0 btn-block">MORE INFOGLOW</a>
                    </div>
                    <img class="py-2 mr-4" src="../assets/img/lipglow-orang-harriet.png" alt="">
                    
                    <div class="card lipglow-card-2 border-0 rounded-0 px-0 my-2">
                        <div class="img-product-lipglow">
                            <img src="../assets/img/lipglow-stargazer.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            <p class="card-title product-text-title-1">STARGAZER LIP GLOW</p>
                        </div>
                        <a href="moreinfo-lipglow.php" class="btn btn-product-1 rounded-0 btn-block">MORE INFOGLOW</a>
                    </div>
                    <img class="py-2 mr-4" src="../assets/img/lipglow-orang-stargazer.png" alt="">
                    
                    <div class="card lipglow-card-2 border-0 rounded-0 px-0 my-2">
                        <div class="img-product-lipglow">
                            <img src="../assets/img/lipglow-keva.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            <p class="card-title product-text-title-1">KEVA LIP GLOW</p>
                        </div>
                        <a href="moreinfo-lipglow.php" class="btn btn-product-1 rounded-0 btn-block">MORE INFOGLOW</a>
                    </div>
                    <img class="py-2 mr-4" src="../assets/img/lipglow-orang-keva.png" alt="">

                    <div class="card lipglow-card-2 border-0 rounded-0 px-0 my-2">
                        <div class="img-product-lipglow">
                            <img src="../assets/img/lipglow-phantom.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            <p class="card-title product-text-title-1">PHANTOM LIP GLOW</p>
                        </div>
                        <a href="moreinfo-lipglow.php" class="btn btn-product-1 rounded-0 btn-block">MORE INFOGLOW</a>
                    </div>
                    <img class="py-2 mr-4" src="../assets/img/lipglow-orang-phantom.png" alt="">

                    <div class="card lipglow-card-2 border-0 rounded-0 px-0 my-2">
                        <div class="img-product-lipglow">
                            <img src="../assets/img/lipglow-ruby.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            <p class="card-title product-text-title-1">RUBY LIP GLOW</p>
                        </div>
                        <a href="moreinfo-lipglow.php" class="btn btn-product-1 rounded-0 btn-block">MORE INFOGLOW</a>
                    </div>
                    <img class="py-2 mr-4" src="../assets/img/lipglow-orang-ruby.png" alt="">
                </div>
            </div>
            <h5 class="col-md-5 timetoglow-quote mx-auto text-center mt-5">It's your time to glow and radiate your inner beauty
        ...
        <div class="jumbotron container-6 rounded-0">
            <div class="container">
                ...
                <div class="row justify-content-center mt-3">
                    ...
                    <a href="lipglow.php" class="footer-menu-text mx-4 font-weight-bold">LIP GLOW</a>
