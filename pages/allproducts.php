...
$sql_items = "SELECT * FROM items ORDER BY item_id ASC";
...
<head>
    ...
    <title>All Products - Cressida Beauty</title>
...
<body>
    <div class="content-1">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active mr-4">
                            <a style="color: #805146 !important; font-family: 'Lato', sans-serif; font-size: 12px; font-weight: 900;" class="nav-link text-uppercase" href="allproducts.php">all products</a>
                        </li>
        ...
        <div class="jumbotron container-1 rounded-0">
            <div class="container px-3">
                <div class="col-md-11 mx-auto mb-5">
                    <div class="row">
                        <h1 class="moto mr-auto">All Products</h1>
                        <div class="pt-5 small-text-black ml-auto"><u>7 Items</u></div>
                    </div>
                    <div class="col-md-11 mx-auto">
                        <div class="row justify-content-center mt-5">
                            ...
                            <!-- <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-boudicca.png" class="img-fluid" alt="">
                                </div>
                            ...
                            <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-hariet.png" class="img-fluid" alt="">
                                </div>
                                <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            ...
                            <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-keva.png" class="img-fluid" alt="">
                                </div>
                                <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            ...
                            <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-stargazer.png" class="img-fluid" alt="">
                                </div>
                                <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                                    <div class="card-title product-text-title-1">STARGAZER LIP GLOW</div>
                                </div>
                                <a href="#" class="btn btn-product-2 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                            </div>
                            <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-phantom-lip.png" class="img-fluid" alt="">
                                </div>
                                <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                                    <div class="card-title product-text-title-1">PHANTOM LIP GLOW</div>
                                </div>
                                <a href="#" class="btn btn-product-2 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                            </div>
                            <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-ruby.png" class="img-fluid" alt="">
                                </div>
                                <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                            ...
                            <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                                <div class="img-product-all-products">
                                    <img src="../assets/img/allproducts-lipglow-kit.png" class="img-fluid" alt="">
                                </div>
                                <div class="card-body bg-card-body-1 text-center pt-3 pb-0">
                                    <div class="card-title product-text-title-1">LIP GLOW KIT</div>
                                </div>
                                <a href="#" class="btn btn-product-2 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                            </div> -->
                        </div>
        ...
        <!-- content section 2 / footer start -->
        <div class="jumbotron container-6 rounded-0">
            <div class="container">
                ...
                <div class="row justify-content-center mt-3">
                    ...
                    <a href="allproducts.php" class="footer-menu-text mx-4 font-weight-bold">ALL PRODUCTS</a>
