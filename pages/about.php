...
<head>
    ...
    <title>About - Cressida Beauty</title>
...
<body>
    <div class="content-2">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active mr-4">
                            <a style="color: #805146 !important; font-family: 'Lato', sans-serif; font-size: 12px; font-weight: 900;" class="nav-link text-uppercase" href="about.php">about</a>
                        </li>
                    </ul>
        ...
        <section class="jumbotron container-about">
            <div class="container">
                <div class="col-md-11 d-flex justify-content-center">
                    <h1 class="about-title mt-4">Because #YouGlowGirl</h1>
                </div>
                <div class="col-md-12">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-4 p-0">
                            <p class="paragraph-about">Cressida Beauty starts from the desire of wanting every women
                                including you to embrace your uniqueness and be #TheBestYou
                                through creating beauty products that enhance your beautiful self.
                                Cressida Beauty is here to add some GLOW into your life and add
                                some confidence to conquer your day</p>

                            <p class="paragraph-about mt-3">Our line of products are designed and formulated with YOU in
                                mind, only using the best quality ingredients to keep you looking
                                good and feeling good.</p>
                                
                            <p class="paragraph-about mt-3">Let’s be a part of #GlowSquad! We stay in constant communication
                                that each of our products are made to reach every single one of
                                you inclusively, because we believe that beauty is for everybody
                                and we believe in your own version of beautiful.</p>

                            <p class="slogan-text-about mt-4">It's your time to glow and radiate your inner beauty
                                Yes, cause #YouGlowGirl</p>
                        </div>
                        <div class="col-md-3">
                            <div class="col d-flex justify-content-center">
                                <img class="img-fluid" src="../assets/img/owner-pict.png" alt="">
                            </div>
                            <p class="paragraph-about text-center">Owner of Cressida Beauty</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8 mx-auto">
                    <div class="row">
                        <img src="../assets/img/about-img1.png" alt="" class="img-fluid m-2" width="658">
                        <img src="../assets/img/about-img2.png" alt="" class="img-fluid m-2">
                        <img src="../assets/img/about-img3.png" alt="" class="img-fluid m-2">
                        <img src="../assets/img/about-img4.png" alt="" class="img-fluid m-2">
                        <img src="../assets/img/about-img5.png" alt="" class="img-fluid m-2">
                        <img src="../assets/img/about-img6.png" alt="" class="img-fluid m-2">
                        <img src="../assets/img/about-img7.png" alt="" class="img-fluid m-2" width="382">
                    </div>
                </div>
                <h5 class="heygirl text-center mt-5">Hey Girls!</h5>
            </div>
        </section>
