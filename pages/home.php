...
$sql_items = "SELECT * FROM items ORDER BY item_id ASC LIMIT 4";
...
<body>
    <div class="content-1">
        ...
        <nav class="px-5 navbar navbar-expand-md sticky-top navbar-light bg-header">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item active mr-4">
                            <a style="color: #805146 !important; font-family: 'Lato', sans-serif; font-size: 12px; font-weight: 900;" class="nav-link text-uppercase" href="home.php">home</a>
                        </li>
                        ...
                        <li class="nav-item mr-4 dropdown">
                            <a style="color: #805146 !important; font-family: 'Lato', sans-serif; font-size: 12px; font-weight: 400;" class="nav-link text-uppercase" href="lipglow.php">lip glow</a>
                        </li>
                        <li class="nav-item mr-4">
        ...
        <div class="jumbotron container-1 rounded-0">
            <img class="logo-white img-fluid" src="../assets/img/logo-white.png" alt="logo-white">
            <div class="container px-3" style="margin-top: -10px;">
                <div class="row justify-content-center mt-4">
                    <div class="col-md-3 my-1 d-flex justify-content-center">
                        <div>
                            <h1 class="moto text-capitalize mt-5">made<br>just<br>for you</h1>
                            <h6 class="small-text-black font-weight-bold" style="margin-top: -5px">It’s time to be #TheBestYou.</h6>
                            <a href="#" class="btn rounded-0 btn-brown mt-4">BUY IT NOW!</a>
                        </div>
                    </div>
                    <div class="col-md-7 my-1">
                        <div class="row justify-content-center">
                            <img class="mx-1 my-1 img-fluid" src="../assets/img/home-foto1.png" alt="">
                            <img class="mx-1 my-1 img-fluid" src="../assets/img/home-foto2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="index col-md-10 border-0 mt-5 mx-auto">
                    <div class="row">
                        <div class="small-text-black font-weight-bold glow mr-auto">GLOW WITH OUR PRODUCTS</div>
                        <a href="allproducts.php" class="small-text-black font-weight-bold all-product ml-auto"><u>SHOP ALL PRODUCTS</u></a>
                    </div>
                    <div class="row mt-3 justify-content-center">
                        ...
                        <!-- <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                            <div class="img-product">
                                <img src="../assets/img/lipstick.png" class="img-fluid" alt="">
                            </div>
                            <div class="card-body bg-card-body-1 text-center p-0">
                                <div class="card-title product-text-title-1">BOUDICCA LIP GLOW</div>
                                <div class="product-text-exp-1">Bold, Sensouos</div>
                            </div>
                            <a href="#" class="btn btn-product-1 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                        </div> 
                        <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                            ...
                            <div class="card-body bg-card-body-1 text-center p-0">
                                <div class="card-title product-text-title-1">HARRIET LIP GLOW</div>
                                <div class="product-text-exp-1">Elegant, Shopisticated</div>
                            </div>
                            <a href="#" class="btn btn-product-1 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                        </div> 
                        <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                            ...
                            <div class="card-body bg-card-body-1 text-center p-0">
                                <div class="card-title product-text-title-1">KEVA LIP GLOW</div>
                                <div class="product-text-exp-1">Whimsical</div>
                            </div>
                            <a href="#" class="btn btn-product-1 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                        </div>
                        <div class="card lipstick-card border-0 rounded-0 px-0 my-2 mx-2">
                            ...
                            <div class="card-body bg-card-body-1 text-center p-0">
                                <div class="card-title product-text-title-1">RUBY LIP GLOW</div>
                                <div class="product-text-exp-1">Edgy, Seductive</div>
                            </div>
                            <a href="#" class="btn btn-product-1 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                        </div>
                        -->
                    </div>
                    <hr class="mx-auto hr-product">
                </div>
            </div>
        </div>
        ...
        <div class="jumbotron container-2 rounded-0">
            <div class="container">
                <h2 class="text-center lipglow-title">Cressida Lip Glow</h2>
                <div class="col-md-5 small-text-black text-center font-weight-bold mx-auto text-lipglow">Products that give you options but never cover you up, turn you into someone else,<br> or over-complicate your routine. Because beauty should make you feel good.</div>
                <div class="d-flex justify-content-center">
                    <a href="#" class="btn rounded-0 btn-brown mt-4">See All Variants</a>
                </div>
                <div class="row lipglow-product justify-content-center">
                    <div class="card lipglow-card-1 border-0 rounded-0 px-0 my-2 mx-2">
                        <div class="img-product-2">
                            <img src="../assets/img/lipglowkit.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-2 text-center p-0">
                            <div class="card-title product-text-title-2">LIP GLOW KIT</div>
                            <div class="product-text-exp-2">Luscious Cressida Lip Glow Kit</div>
                        </div>
                        <a href="#" class="btn btn-product-2 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                    </div>
                    <div class="card lipglow-card-1 border-0 rounded-0 px-0 my-2 mx-2">
                        <div class="img-product-2">
                            <img src="../assets/img/phantom.png" class="img-fluid" alt="">
                        </div>
                        <div class="card-body bg-card-body-2 text-center p-0">
                            <div class="card-title product-text-title-2">PHANTOM LIP GLOW</div>
                            <div class="product-text-exp-2">Fierce, Unapologetic</div>
                        </div>
                        <a href="#" class="btn btn-product-2 rounded-0 btn-block">Add To Bag - Rp145.000</a>
                    </div>
                    <img src="../assets/img/home-foto3.png" alt="foto3" class="mx-2 img-fluid">
                </div>
            </div>
        </div>
        ...
        <div class="jumbotron container-3 rounded-0">
            <div class="container">
                <h2 class="text-center yourglow-title">Show Us Your GLOW</h2>
                <div class="col-md-5 text-center mx-auto text-yourglow">Share your photo using our products, tag us @cressidabeauty and #CressidaBeauty<br> on your instagram feed to get a chance to be featured below!</div>
                <div class="slick center mt-5">
                    <div class="mx-1">
                        <img src="../assets/img/home-foto-carousel.png" alt="carousel" class="img-fluid">
                    </div>
                    <div class="mx-1">
                        <img src="../assets/img/home-foto-carousel.png" alt="carousel" class="img-fluid">
                    </div>
        ...
        <div class="jumbotron container-4 rounded-0">
            <div class="container">
                <h2 class="text-center coz-glow-title mt-3">Because #YouGlowGirl</h2>
                <div class="row mt-5 justify-content-center">
                    <div class="col-md-3 my-3">
                        <svg width="45" height="51" viewBox="0 0 25 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.5 19.5V28.5C16.1667 29.3333 20.5 30.5 24.5 28.5V19.5M14.5 19.5H24.5M14.5 19.5V17.5M24.5 19.5V17.5M24.5 17.5V14.5H14.5V16V17.5M24.5 17.5H14.5" stroke="#8E4C40"/>
                            <path d="M2 14.5H1V28C5 30.4 9.33333 29 11 28V14.5H10M2 14.5V10.5H3.5M2 14.5H10M10 14.5V10.5H9M3.5 10.5H9M3.5 10.5V7M9 1.49997C5.8 1.09997 4 3.33331 3.5 4.49997V7M9 1.49997V10.5M9 1.49997C8.6 4.29995 5.16667 6.33332 3.5 7" stroke="#8E4C40"/>
                        </svg>
                            
                        <p class="small-text-4 mt-3">Cressida Beauty starts from the desire of
                            wanting every women including you to
                            embrace your uniqueness and be
                            #TheBestYou through creating beauty
                            products that enhance your beautiful self.
                        </p>
                    </div>
                    <div class="col-md-3 my-3">
                        <svg width="56" height="43" viewBox="0 0 36 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="small-text-4 mt-3" style="margin-top: 25px !important;">Our line of products are designed and formulated with YOU
                            in mind, only using the best quality ingredients to keep you looking good and feeling good.
                        </p>
                    </div>
                    <div class="col-md-3 my-3">
                        <svg width="52" height="45" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect y="6" width="4" height="2" rx="1" fill="#8E4C40"/>
                            <rect x="18" y="6" width="4" height="2" rx="1" fill="#8E4C40"/>
                            <path d="M2 7.5C2.16667 10.6667 3.7 17.1 10.5 17.5C17.3 17.9 20 12 20 7.5" stroke="#8E4C40"/>
                            <path d="M9.5 22.5V17.5H11.5V22.5M9.5 22.5H6.5C6.16667 22.6667 5.5 23.3 5.5 24.5H16.5C16.5 23.8333 16.3 22.5 15.5 22.5H11.5M9.5 22.5H11.5" stroke="#8E4C40"/>
                            <path d="M18.5 8.5C18.5 12.9473 15.114 16.5 11 16.5C6.88599 16.5 3.5 12.9473 3.5 8.5C3.5 4.05273 6.88599 0.5 11 0.5C15.114 0.5 18.5 4.05273 18.5 8.5Z" stroke="#8E4C40"/>
                        </svg>
                            
                        <p class="small-text-4 mt-3">Let’s be a part of #GlowSquad! We stay in
                            constant communication that each of our
                            products are made to reach every single
                            one of you inclusively, because we believe
                            that beauty is for everybody and we
                            believe in your own version of beautiful.
                        </p>
                    </div>
                </div>
                <div class="col-md-5 timetoglow-quote mx-auto text-center mt-5">It's your time to glow and radiate your inner beauty
                    Yes, cause #YouGlowGirl
                </div>
            </div>
        </div>
        ...
        <div class="jumbotron container-5 rounded-0">
            <div class="container">
                <div class="title text-center">Cressida Beauty Instagram</div>
        ...
        <!-- content section 6 / footer start -->
        <div class="jumbotron container-6 rounded-0">
            <div class="container">
                ...
                <div class="row justify-content-center mt-3">
                    <a href="home.php" class="footer-menu-text mx-4 font-weight-bold">HOME</a>
                    ...
                    <a href="about.php" class="footer-menu-text mx-4">ABOUT</a>
                </div>
