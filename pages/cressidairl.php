...
<head>
    ...
    <title>Cressida Irl - Cressida Beauty</title>
...
<body>
    <div class="content-3">
        ...
        <nav class="px-5 navbar navbar-expand-md sticky-top navbar-light bg-header-irl">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active mr-4">
                            <a style="color: #805146 !important; font-family: 'Lato', sans-serif; font-size: 12px; font-weight: 900;" class="nav-link text-uppercase" href="cressidairl.php">cressda irl</a>
                        </li>
                        <li class="nav-item mr-4">
        ...
        <section class="jumbotron container-irl">
            <div class="container">
                <h1 class="irl-title mt-4 text-center">Show Us Your GLOW</h1>
                <div class="col-md-6 paragraph-about text-center mx-auto">Share your photo using our products, tag us @cressidabeauty and #CressidaBeauty
                    on your instagram feed to get a chance to be featured below!
                </div>
                
                <div class="col-md-9 mt-4 mx-auto">
                    <div class="grid-container-left">
                        <div class="item1-left">
                            <img src="../assets/img/irl-img1.png" alt="" class="img-fluid">
                        </div>
                        <div class="item2">
                            <img src="../assets/img/irl-img2.png" alt="" class="img-fluid">
                        </div>
                        <div class="item3">
                            <img src="../assets/img/irl-img3.png" alt="" class="img-fluid">                            
                        </div>  
                        <div class="item4">
                            <img src="../assets/img/irl-img4.png" alt="" class="img-fluid">                            
                        </div>
                        <div class="item5">
                            <img src="../assets/img/irl-img5.png" alt="" class="img-fluid">                            
                        </div>
                    </div>
                    <div class="grid-container-right mt-2">
                        <div class="item1-right">
                            <img src="../assets/img/irl-img10.png" alt="" class="img-fluid">
                        </div>
                        <div class="item2">
                            <img src="../assets/img/irl-img6.png" alt="" class="img-fluid">
                        </div>
                        <div class="item3">
                            <img src="../assets/img/irl-img7.png" alt="" class="img-fluid">                            
                        </div>  
                        <div class="item4">
                            <img src="../assets/img/irl-img8.png" alt="" class="img-fluid">                            
                        </div>
                        <div class="item5">
                            <img src="../assets/img/irl-img9.png" alt="" class="img-fluid">                            
                        </div>
                    </div>
                </div>

                <div class="col-md-4 mx-auto mt-5">
                    <a href="#" class="btn btn-brown-irl btn-block rounded-0">SHOW MORE</a>
                </div>
            </div>
        </section>
        ...
        <div class="jumbotron container-6 rounded-0">
            <div class="container">
                ...
                <div class="row justify-content-center mt-3">
                    ...
                    <a href="cressidairl.php" class="footer-menu-text mx-4 font-weight-bold">CRESSIDA URL</a>
