...
<head>
    ...
    <title>Login - Cressida Beauty</title>
...
<body>
    <div class="container py-5">
        <div class="col-md-5 mt-3 mx-auto">
            ...
            <h5 class="login-form-text-color text-center mt-3">Login User</h5>
            <hr class="hr-login-form-title mx-auto">
            <div class="text-dark mt-4">Don't have account yet? <a href="register.php" class="login-form-text-color reglog-text">Register here</a></div>
            <form action="" method="POST" class="mt-3">
                <div class="form-group">
                    <input type="text" name="username" class="form-control rounded-0" placeholder="Username or Email" required>
                </div>

                <div class="form-group">
                    <input type="password" name="password" class="form-control rounded-0" placeholder="Password" required>
                </div>
                <div class="myrow justify-content-between">
                    <label class="checkbox">
                        <input type="checkbox" value="remember-me" id="remember_me"> Remember me
                    </label>
                    <a href="#" class="login-form-text-color reglog-text">Forgot password?</a>
                </div>
                <div class="form-group">
                    <input type="submit" name="submit" class="btn btn-block btn-brown-login rounded-0 mt-3" value="Login">
                </div>
                <!-- <a href="../home.php" class="btn btn-block btn-brown-login rounded-0 mt-3">Login</a> -->
